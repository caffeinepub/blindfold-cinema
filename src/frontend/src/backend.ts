...
import type { Content as _Content, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createContent(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob, arg4: ExternalBlob | null, arg5: string, arg6: boolean): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createContent(arg0, arg1, arg2, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg3), await to_candid_opt_n11(this._uploadFile, this._downloadFile, arg4), arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContent(arg0: bigint): Promise<Content> {
        if (this.processError) {
            try {
                const result = await this.actor.getContent(arg0);
                return from_candid_Content_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getContentByCategory(arg0: string): Promise<Array<Content>> {
        if (this.processError) {
            try {
    ...
    async getContentBySearch(arg0: string): Promise<Array<Content>> {
        if (this.processError) {
            try {
                const result = await this.actor.getContentBySearch(arg0);
                return from_candid_vec_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateContent(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: ExternalBlob, arg5: ExternalBlob | null, arg6: string, arg7: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateContent(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg4), await to_candid_opt_n11(this._uploadFile, this._downloadFile, arg5), arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Content_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Content): Promise<Content> {
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        thumbnailKey: record_opt_to_undefined(await from_candid_opt_n15(_uploadFile, _downloadFile, value.thumbnailKey)),
        isPublished: value.isPublished,
        createdAt: value.createdAt,
        description: value.description,
        category: value.category,
        rating: value.rating,
        fileKey: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.fileKey)
    };
}
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Content>): Promise<Array<Content>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Content_n13(_uploadFile, _downloadFile, x)));
}
