...
export const Content = IDL.Record({
  ...
  'duration' : IDL.Text,
  'thumbnailKey' : IDL.Opt(ExternalBlob),
...
export const idlService = IDL.Service({
  ...
  'getContentByCategory' : IDL.Func([IDL.Text], [IDL.Vec(Content)], ['query']),
  'getContentBySearch' : IDL.Func([IDL.Text], [IDL.Vec(Content)], ['query']),
